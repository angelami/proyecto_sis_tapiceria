	...
	<div class="formu_ingreso_datos">
		<form action="proveedor_modificar1.php" method="post" name="formu">
			...
			{foreach item=r from=$proveedor}
				...
				<input type="text" name="nombre" size="20" placeholder="Nombre" onkeyup="this.value=this.value.toUpperCase()" value="{$r.nombre}">(*)
			
			<p>
				<input type="text" name="direccion" size="30" placeholder="Direccion" onkeyup="this.value=this.value.toUpperCase()" value="{$r.direccion}">
			</p>
